...
/// <summary>
/// Defines a service for capturing bands, albums, and rendered HTML from a web page using raw navigation and resource capture strategies.
/// </summary>
/// <remarks>
/// <para>
/// Implementations must provide asynchronous capture of bands and albums, supporting sign-in, referer, timing, resource capture, and optional response rewriting.
/// </para>
/// <para>
/// Cancellation is supported for all asynchronous operations via <see cref="CancellationToken"/>.  If cancellation is requested before or during capture, an <see cref="OperationCanceledException"/> is thrown.  If the browser or page is externally closed, an <see cref="OperationCanceledException"/> is also thrown.
/// </para>
/// </remarks>
public interface IRawNavigateAndCaptureSampleService
{
    /// <summary>
    ...
    /// <returns>
    /// A tuple containing the parsed <see cref="Bands"/>, <see cref="Albums"/>, and the rendered HTML string
