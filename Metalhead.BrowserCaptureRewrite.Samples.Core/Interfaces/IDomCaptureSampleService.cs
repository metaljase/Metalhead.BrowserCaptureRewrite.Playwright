...
/// <summary>
/// Defines a service for capturing the rendered HTML of a web page, supporting sign-in, referer, and timing options.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public interface IDomCaptureSampleService
{
    /// <summary>
    ...
    /// <returns>
    /// The rendered HTML of the page, or <see langword="null"/> if not available.
    /// </returns>
    ...
    /// <exception cref="ConnectivityException">Thrown if a connectivity error occurs while capturing.</exception>
    /// <exception cref="HttpRequestException">Thrown if an HTTP error occurs while capturing.</exception>
    /// <exception cref="TimeoutException">Thrown if a timeout occurs while capturing.</exception>
    /// <exception cref="OperationCanceledException">Thrown if the operation is cancelled before or during capture.</exception>
    Task<string?> CaptureBandsAndAlbumsAsync(
        Uri url,
        Uri? referrerUrl,
        Uri? signInUrl,
